...
function About() {
  return (
    ...
    >
      <GlassCard className="grid gap-7 p-6 md:grid-cols-[220px_1fr] md:gap-10 md:p-8">
        <div className="overflow-hidden rounded-2xl border border-border bg-black/25">
          <img
        ...
        <div>
          ...
          <h3 className="mt-3 text-2xl tracking-tight">Precision-led creative direction.</h3>
